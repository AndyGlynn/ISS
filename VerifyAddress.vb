            ...
            Select Case Me.ArValues.Count  ''count of actual valid addresses
                Case Is <= 0
                    Select Case Me.RunCnt
                        Case Is = 1
                            'KillProcess()
                            Dim x = New VerifyAddress(StAddress, City, State, "", 2)

                            Exit Sub
                        Case Is = 2
                            'KillProcess()
                            Dim x = New VerifyAddress(StAddress, City, "", "", 3)

                            Exit Sub
                        Case Is = 3
                            Dim response As Integer = MsgBox("Map Point was unable to find a valid address... Would you like to edit the address?" & _
                ...
                Case Is > 1
                    ...
                    Next
                    AddressEnterLead.frm = EnterLead
                ...
                Case Is = 1
                    ...
                    If Me.Valid = True And Me.CntValid = 1 Then
                        EnterLead.txtStAddy.Text = Me.Loc2.StreetAddress.Street
                        EnterLead.txtCity.Text = Me.Loc2.StreetAddress.City
                        EnterLead.txtState.Text = Me.Loc2.StreetAddress.Region
                        EnterLead.txtZip.Text = Me.Loc2.StreetAddress.PostalCode
