...
#End Region
    ...
    Public Sub New()
        ...
        Dim map_struct As New ImportData_V2.sqlOperations.Record_And_Address
        ...
        While r1.Read
            ...
            While r2.Read
                ...
                If counter = 0 Then
                    ...
                    Dim param33 As SqlParameter = New SqlParameter("@Email", "")
                ...
                If WriteSRsult = True Then
                    ...
                    cnnSR.Close()
                    cnnSR = Nothing
                    If id = "a043100000dwFaDAAU" Then
                        MsgBox(RCorBR & "              " & Recover.ToString)
                    End If
            ...
            '' 11-9-2015
            '' after the lead is inserted, we are going to nest the mappoint address scrub here
            '' inside the loop => make a new struct and get info to struct
            '' outside the loop => pass struct to mappoint to verify the address
            '' outside the loop => once verified update the respective table that the address has been verified or not. 
            '' 
